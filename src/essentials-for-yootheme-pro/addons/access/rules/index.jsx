...
export async function getStaticProps() {
  const misc = getAllPosts(
    'essentials-for-yootheme-pro/addons/access/rules',
    ['title','slug','description','icon']
  )

  const site = getAllPosts(
    'essentials-for-yootheme-pro/addons/access/rules/site',
    ['title', 'slug', 'description', 'icon']
  )
  ...
  const datetime = getAllPosts(
    'essentials-for-yootheme-pro/addons/access/rules/datetime',
    ['title', 'slug', 'description', 'icon']
  )
