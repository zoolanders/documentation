...
::: info Post URL
LinkedIn API doesn't provide a direct link to individual posts. If you need to link to a post, you must manually copy its URL from the LinkedIn platform.
:::
