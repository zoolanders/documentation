...
This source is based on Media from Vimeo. Once the source has been created, as instructed in the [Getting Started](../README.md) guide, you will be able to map its contents to any Builder element.
