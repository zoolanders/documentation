...
<div class="tm-resource-icon">
    <!--@include: ./assets/brands/linkedin.svg-->
</div>

The LinkedIn integration is available through [LinkedIn Source](../addons/dynamic/sources/linkedin). Use it to fetch organization posts from LinkedIn organizations that the authenticated user administers.

LinkedIn requires a custom LinkedIn developer app because ZOOlanders OAuth Apps are not supported for this provider. Create your own app, then use its generated tokens with the [LinkedIn Auth](../auths/drivers/linkedin) driver when configuring the LinkedIn Source.
