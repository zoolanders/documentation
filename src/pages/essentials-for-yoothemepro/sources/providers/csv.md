---
title: CSV Source
description: Content Source based on CSV and TSV files
icon: '
...
Queries records from the source instance, resolves to a List Of programatically generated `Object Type` based on the file columns schema.
