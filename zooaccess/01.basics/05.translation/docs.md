...
Download the translated file from Transifex and place it into **administrator/language/{LANG}** folder under the name **{LANG}.plg_system_zooaccess.ini**. E.g: **administrator/language/es-ES/es-ES.plg_system_zooaccess.ini**

>>>>> The default **en-GB.plg_system_zooaccess.ini** language file is located in the **administrator/language/en-GB** folder.
