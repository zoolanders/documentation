...
* **How can a frontend user renew his/her [Subscribtion](/extensions/zoocart/basics/integration#subscriptions)?** <br /> Firstly, make sure you have added the Subscriptions [menu item](/extensions/zoocart/basics/integration#menu-assignment). On the Subscription page user can see the list of Subscriptions. After a Subscription is ended, the "Renew" button is shown (if this subscription product still exists). When the user clicks "Renew" this product will be added to the Cart. Then the user follows the standard checkout process.
