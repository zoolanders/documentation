...
Download the translated file from Transifex and place it into **administrator/language/{LANG}** folder under the name **{LANG}.mod_zooitempro.ini**. E.g: **administrator/language/es-ES/es-ES.mod_zooitempro.ini**

>>>>> The default **en-GB.mod_zooitempro.ini** language file is located in the **administrator/language/en-GB** folder.
