...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"ZOOlanders","description":"Guides and Documentation for Essential Addons.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/zoolanders-logo.svg","siteTitle":false,"editLink":{"pattern":"https://github.com/zoolanders/documentation/edit/v3/src/:path"},"nav":[{"text":"YOOtheme Pro Essentials","link":"/essentials-for-yootheme-pro/","activeMatch":"/essentials-for-yootheme-pro/"},{"text":"ZOO Essentials","link":"/essentials-for-zoo/","activeMatch":"/essentials-for-zoo/"}],"sidebar":{"/essentials-for-zoo/":[{"text":"Getting Started","items":[{"text":"Introduction","link":"/essentials-for-zoo/"},{"text":"Installation","link":"/essentials-for-zoo/installation"},{"text":"Changelog","link":"https://www.zoolanders.com/essentials-for-zoo/changelog"}]},{"text":"General","base":"/essentials-for-zoo","items":[{"text":"SEO","link":"/seo"},{"text":"Metadata","link":"/metadata"},{"text":"Import/Export","link":"/import-export"},{"text":"ZOO Item Pro","link":"/addons/zooitempro"},{"text":"Widgetkit","link":"/widgetkit"}]},{"text":"Pro Elements","base":"/essentials-for-zoo/addons/elements","items":[{"text":"Overview","link":"/"},{"text":"Conditional Rendering","link":"/conditional-rendering"},{"text":"Elements","collapsed":true,"items":[{"text":"Date Pro","link":"/date-pro"},{"text":"Download Pro","link":"/download-pro"},{"text":"Google Maps Pro","link":"/google-maps-pro"},{"text":"Image Pro","link":"/image-pro"},{"text":"Link Pro","link":"/link-pro"},{"text":"Media Pro","link":"/media-pro"},{"text":"Related Items Pro","link":"/related-items-pro"},{"text":"Related Categories Pro","link":"/related-categories-pro"},{"text":"Text Pro","link":"/text-pro"},{"text":"Textarea Pro","link":"/textarea-pro"},{"text":"Separator","link":"/separator"},{"text":"Static Content","link":"/static-content"}]}]},{"text":"Items Filtering","base":"/essentials-for-zoo/addons/filter","items":[{"text":"Overview","link":"/"},{"text":"Module","link":"/module"},{"text":"Elements","link":"/elements"},{"text":"Recipes","link":"/recipes"},{"text":"F.A.Q.","link":"/faq"}]},{"text":"Multilingual","base":"/essentials-for-zoo/addons/lingual","items":[{"text":"Overview","link":"/"},{"text":"F.A.Q.","link":"/faq"}]},{"text":"Developer","base":"/essentials-for-zoo/addons","items":[{"text":"ZOO Filter Customizations","link":"/filter/customizations"},{"text":"ZOO Item Pro Customizations","link":"/zooitempro/customizations"},{"text":"Elements Customizations","link":"/elements/customizations"}]},{"text":"Troubleshooting","base":"/essentials-for-zoo","items":[{"text":"SEO Issues","link":"/troubleshooting/seo"},{"text":"Import Issues","link":"/troubleshooting/port"},{"text":"Elements Issues","link":"/addons/elements/troubleshooting"},{"text":"Widgetkit Issues","link":"/troubleshooting/widgetkit"},{"text":"ZOO Filter Issues","link":"/addons/filter/troubleshooting"}]}],"/essentials-for-yootheme-pro/":[{"text":"Getting Started","items":[{"text":"Introduction","link":"/essentials-for-yootheme-pro/"},{"text":"Installation","link":"/essentials-for-yootheme-pro/installation"},{"text":"Changelog","link":"https://www.zoolanders.com/essentials-for-yootheme-pro/changelog"}]},{"text":"General","base":"/essentials-for-yootheme-pro/","items":[{"text":"Auth, Keys & Secrets","link":"auths-and-secrets"},{"text":"Auth Drivers","link":"auth-drivers"},{"text":"Settings","link":"settings"}]},{"text":"Forms Builder","base":"/essentials-for-yootheme-pro/addons/forms","items":[{"text":"Integration","link":"/"},{"text":"Form Area","link":"/form-area"},{"text":"Actions","link":"/actions/"},{"text":"Elements","link":"/elements"},{"text":"Captcha","link":"/captcha"},{"text":"Data Workflow","link":"/data-workflow"}]},{"text":"Dynamic Sources","base":"/essentials-for-yootheme-pro/addons/sources","items":[{"text":"Integration","link":"/"},{"text":"Sources","link":"/providers"},{"text":"Conditions & Filters","link":"/conditions-and-filters"}]},{"text":"Dynamic Content","base":"/essentials-for-yootheme-pro/addons/dynamic","items":[{"text":"Integration","link":"/"},{"text":"Extended Workflow","link":"/extended-workflow"},{"text":"Composed Sources","link":"/composed-sources"}]},{"text":"Access Conditions","base":"/essentials-for-yootheme-pro/addons/access","items":[{"text":"Integration","link":"/"},{"text":"Condition","link":"/condition"},{"text":"Rules","link":"/rules"}]},{"text":"Icons","base":"/essentials-for-yootheme-pro/addons/icons","items":[{"text":"Integration","link":"/"},{"text":"Collections","link":"/collections"},{"text":"My Icons","link":"/my-icons"}]},{"text":"Layout Libraries","base":"/essentials-for-yootheme-pro","items":[{"text":"Integration","link":"/addons/layouts/"},{"text":"Libraries","link":"/addons/layouts/libraries"},{"text":"Storage Abstraction","link":"/storage"}]},{"text":"Elements","base":"/essentials-for-yootheme-pro/addons/elements","items":[{"text":"Integration","link":"/"},{"text":"Chart","link":"/chart"},{"text":"Markdown","link":"/markdown"},{"text":"Social Sharing","link":"/social-sharing"}]},{"text":"Developer","base":"/essentials-for-yootheme-pro/developer","items":[{"text":"Custom Form Action","link":"/custom-form-action"},{"text":"Custom Source Provider","link":"/custom-source-provider"},{"text":"Custom Access Rule","link":"/custom-access-rule"},{"text":"Custom Icon Collection","link":"/custom-icon-collection"},{"text":"Custom Twitter Dev App","link":"/custom-twitter-dev-app"},{"text":"Form Hooks","link":"/form-hooks"}]},{"text":"Troubleshooting","base":"/essentials-for-yootheme-pro/addons","items":[{"text":"Forms Issues","link":"/forms/troubleshooting"},{"text":"Sources Issues","link":"/sources/troubleshooting"},{"text":"Icon Issues","link":"/icons/troubleshooting"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/zoolanders/documentation"},{"icon":"twitter","link":"https://twitter.com/jzoolanders"},{"icon":"discord","link":"https://discord.gg/3BT5nHauWr"}],"footer":{"message":"Essentials for YOOtheme Pro and ZOO","copyright":"Copyright © <a href=\\"https://zoolanders.com\\">ZOOlanders</a>"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-d4a0bba5"]]);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$$, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<article class="box" data-v-23e3fac8${_scopeId}>`);
            if (__props.icon) {
              _push2(`<div class="icon" data-v-23e3fac8${_scopeId}>`);
              _push2(ssrRenderComponent(VPImage, {
                image: __props.icon,
                alt: __props.title,
            ...
            _push2(`<div data-v-23e3fac8${_scopeId}><span class="title" data-v-23e3fac8${_scopeId}>${__props.title ?? ""}</span>`);
            if (__props.details) {
              _push2(`<p class="details" data-v-23e3fac8${_scopeId}>${__props.details ?? ""}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></article>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/components/TmIndexItem.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const TmIndexItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-23e3fac8"]]);
const _sfc_main$1 = {
  __name: "TmIndex",
  __ssrInlineRender: true,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.items) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "TmIndexItems" }, _attrs))} data-v-69e55f02><div class="container" data-v-69e55f02><div class="items" data-v-69e55f02><!--[-->`);
        ssrRenderList(__props.items, (item) => {
          _push(`<div class="${ssrRenderClass([[grid.value], "item"])}" data-v-69e55f02>`);
          _push(ssrRenderComponent(TmIndexItem, {
            icon: item.icon,
            title: item.title,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/components/TmIndex.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const TmIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-69e55f02"]]);
const _sfc_main = {
  __name: "MyLayout",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    function toggleResourceIconsColor(isDark2) {
      nextTick(() => {
        const svgElements = document.querySelectorAll(".tm-resource-icon svg > *");
        svgElements.forEach((el) => {
          if (el.getAttribute("fill") !== "none") {
            el.setAttribute("fill", isDark2 ? "#fffff5db" : "#444");
          }
          if (el.getAttribute("stroke") !== "none") {
            el.setAttribute("stroke", isDark2 ? "#fffff5db" : "#444");
          }
        });
      });
    }
